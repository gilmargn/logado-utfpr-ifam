...
\vspace{0.5in}
   \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[scale=0.12]{logado}\\
            \textbf{Logado}
        \end{column} 
    \end{columns}
\end{frame}
...
\section{Algoritmo - desenvolvimento e rastros}
\begin{frame}{Exemplo de algoritmo}
	\includegraphics[scale=0.3]{algoritmo0}
\end{frame}
\begin{frame}{Exemplo de rastreamento}
	\includegraphics[scale=0.23]{log1}
\end{frame}
\begin{frame}{Continuação}
	\includegraphics[scale=0.23]{log2}
\end{frame}
...
\includegraphics[scale=0.22]{marketplace}
\end{frame}
