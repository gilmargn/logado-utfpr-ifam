...
% Definir coverpageone se não existir
\providecommand{\coverpageone}{}
...
\include{./capitulos/cap-resultados-discussoes}
\include{./capitulos/cap-consideracoes-finais}
...
%   %% Capítulo de exemplo
  ...
  \include{./PosTexto/apendicec}	  
  \includepdf[pages=-]{./PosTexto/Mod1TermodeCompromisso}
  \includepdf[pages=-]{./PosTexto/autorizacao-labin-assinado}
  \includepdf[pages=-]{./PosTexto/termo-utilizacao-dados}
  \includepdf[pages=-]{./capitulos/tcle.pdf}
 % \includepdf[pages=-]{./PosTexto/questionario-previo-tcle.pdf}%% Anexo - Comente para remover este item
 %  \includepdf[pages=-]{./PosTexto/feedback}
...
\include{./PosTexto/questionario-previo-tcle.pdf}%% Anexo - Comente para remover este item
  %\include{./PosTexto/feedback}%% Anexo - Comente para remover este item
