...
\usepackage[a-1b,mathxmp]{pdfx}%[2018/12/22] % você pode escolher entre a-1b, a-2b, a-3b - o template ainda não suporta o a-Xa de 
...
%   %% Capítulo de exemplo
   ...
   \includepdf[pages=-]{./PosTexto/questionario-previo-tcle.pdf}
