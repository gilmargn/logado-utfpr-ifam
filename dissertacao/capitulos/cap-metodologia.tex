...
\begin{figure}[H]
    ...
    \begin{ganttchart}[
        vgrid={*{11}{gray!20, dotted}},
        hgrid,
        x unit=1.1cm,  % Reduzido de 1.5cm
        y unit title=0.8cm,
        y unit chart=0.7cm,
        ...
        bar height=0.4,
        bar label font=\tiny,
        bar label node/.append style={left=1.5pt, text width=2.2cm, align=right},
        milestone/.style={shape=rectangle},
        milestone label font=\tiny\bfseries,
        inline
        ]{1}{11}
    
    % Year and month titles
    \gantttitle{2025}{5} \gantttitle{2026}{6} \\
    \gantttitlelist{8,9,10,11,12}{1} \gantttitlelist{1,2,3,4,5,6}{1} \\
    
    % Activities com cores diferentes
    \ganttbar[bar/.append style={fill=blue!60}]{}{3}{5} \\     % Qualificação
    \ganttbar[bar/.append style={fill=green!60}]{}{7}{8} \\    % Experimento 1
    \ganttbar[bar/.append style={fill=orange!60}]{}{9}{10} \\   % Experimento 2
    \ganttbar[bar/.append style={fill=purple!60}]{}{10}{11} \\  % Conclusão pesquisa
    \ganttbar[bar/.append style={fill=teal!60}]{}{2}{10} \\    % Submissão artigos
    \ganttbar[bar/.append style={fill=brown!60}]{}{1}{11} \\   % Escrita dissertação
    \ganttbar[bar/.append style={fill=red!80}]{} {11}{11} % Entrega
    ...
    \textcolor{blue}{\rule{6pt}{6pt}} & Qualificação &
    \textcolor{green}{\rule{6pt}{6pt}} & Experimento 1 &
    \textcolor{orange}{\rule{6pt}{6pt}} & Experimento 2 \\
    \textcolor{purple}{\rule{6pt}{6pt}} & Conclusão pesquisa &
    \textcolor{teal}{\rule{6pt}{6pt}} & Submissão artigos &
    \textcolor{brown}{\rule{6pt}{6pt}} & Escrita dissertação \\
    \textcolor{red}{\rule{6pt}{6pt}} & Entrega dissertação & & & &
    \end{tabular}
    \end{minipage}
    
    \caption{Cronograma do trabalho de mestrado}
    \label{fig:gantt}
\end{figure}

Conforme pode ser visualizado na Figura \ref{fig:gantt}, as atividades foram planejadas de modo mensal. Inicialmente, para agosto de 2025 estavam previstas: (1) a qualificação da proposta de dissertação; e (2) a execução da parte da Fase 3, por meio da validação, análise e interpretação dos dados coletados na primeira execução do experimento de avaliação da abordagem (ocorrerá em novembro de 2025). A segunda atividade será finalizada em setembro, sendo seguida pela realização de eventuais ajustes na abordagem (Fase 2), cujo término é previsto para outubro.
